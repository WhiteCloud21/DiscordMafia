...
namespace DiscordMafia.Items
{
    public class AntiMask : BaseItem
    {
        ...
        public override string Description
        {
            get
            {
                return "Покупая прибор ночного видения, игрок на одну ночь получает способность видеть и действовать сквозь маски. Таким образом, ПНВ является контрпредметом маске.";
            }
        }
