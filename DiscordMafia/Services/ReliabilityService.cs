// Original source https://gist.github.com/foxbot/7d81edab4e36497c643828638af289b8 by foxbot
    ...
    public class ReliabilityService
    {
        ...
        private async Task CheckStateAsync()
        {
            ...
            if (_attemptReset)
            {
                ...
                {
                    await DebugAsync("UnknownState!" + connect.IsCompleted + connect.IsCanceled + connect.Status);
                }
                return;
            }
